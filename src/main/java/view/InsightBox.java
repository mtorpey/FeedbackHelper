...
public class InsightBox extends JPanel {
    ...
    public InsightBox(IAppController controller, LinkedPhrases linkedPhrases) {
        ...
        this.setBorder(
            new CompoundBorder(new EmptyBorder(20, 10, 0, 10), new LineBorder(Configuration.COLOR_INSIGHT_BORDER, 1))
        );
    ...
    private void setupPhraseBoxes() {
        this.phraseBox1 = new PhraseBox(
            this.controller,
            this.linkedPhrases.getFirst().getPhraseAsString(),
            this.linkedPhrases.getFirst().getUsageCount()
        );
        this.phraseBox2 = new PhraseBox(
            this.controller,
            this.linkedPhrases.getSecond().getPhraseAsString(),
            this.linkedPhrases.getSecond().getUsageCount()
        );
    ...
    private void setupInfoText() {
        JTextArea infoText = new JTextArea(
            "The following phrases have been paired together " + this.linkedPhrases.getCount() + " times."
        );
